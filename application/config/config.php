...
|
*/
$config['base_url'] = 'http://localhost/authci/';
...
$config['login_select'] = array('id','username');

// FACEBOOK CREDENTIAL
$config['FACEBOOK_ID'] = 'XXXXXXXXXXXXXX';
$config['FACEBOOK_SECRET'] = 'XXXXXXXXXXXXXXXX';
$config['GRAPH_version'] = 'v2.5';
$config['FACEBOOK_CALLBACK_URL'] = 'facebookController/callBack';
